...
(function (root) {
  ...
  var TABLES = {
    en: {
      ...
      savePng: 'Save PNG',
      savePngHint: 'Save this plot as an image',
      saveFailed: 'the plot could not be saved',
      zeroCentered: '0 centered',
      zeroCenteredHint: 'Keep zero in the middle of both axes',
      autoFit: 'auto fit',
      autoFitHint: 'Move the axis sliders to follow the parameters',
    ...
    pt: {
      ...
      savePng: 'Salvar PNG',
      savePngHint: 'Salvar este gráfico como imagem',
      saveFailed: 'não foi possível salvar o gráfico',
      zeroCentered: 'centrado no 0',
      zeroCenteredHint: 'Manter o zero no meio dos dois eixos',
      autoFit: 'ajuste automático',
      autoFitHint: 'Mover os controles dos eixos junto com os parâmetros',
    ...
    es: {
      ...
      savePng: 'Guardar PNG',
      savePngHint: 'Guardar esta gráfica como imagen',
      saveFailed: 'no se pudo guardar la gráfica',
      zeroCentered: 'centrado en 0',
      zeroCenteredHint: 'Mantener el cero en el medio de ambos ejes',
      autoFit: 'ajuste automático',
      autoFitHint: 'Mover los controles de los ejes junto con los parámetros',
